...
export default async function QuoteSuccessPage({ searchParams }: QuoteSuccessPageProps) {
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center bg-brand-jet">
        <div className="text-center">
          <p className="font-display text-display-sm text-brand-white">No quote request found</p>
          <Link href="/quote/estimate" className="mt-6 inline-block rounded-xl bg-brand-red px-6 py-3 font-body text-body-sm font-semibold text-white hover:bg-brand-red-hover">
            Start Quote
          </Link>
        </div>
      </div>
      ...
      <div className="section-container pt-16">
        <div className="mx-auto max-w-2xl">
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <h1 className="mb-2 font-display text-display-md text-brand-white">Quote Request Received</h1>
            <p className="font-body text-body-lg text-brand-smoke">
              Your wheel refinishing request has been saved for Western Wheelcraft review.
            </p>
          </div>
          ...
          <div className="mb-6 overflow-hidden rounded-3xl border border-brand-graphite bg-brand-graphite shadow-card">
            <div className="border-b border-brand-graphite-light bg-brand-graphite-light px-6 py-4">
              <div className="flex items-center justify-between gap-4">
                ...
                <p className="break-all font-mono text-body-sm font-bold text-brand-white">{quote}</p>
              </div>
            </div>
            ...
            <div className="px-6 py-5">
              <div className="rounded-2xl border border-warning/30 bg-warning/10 px-5 py-4">
                ...
                <p className="mt-1 font-body text-caption text-brand-smoke">
                  Stripe deposits will be enabled in a later production phase. The admin team can review this quote request now.
                </p>
              </div>

              <div className="mt-5 rounded-2xl border border-brand-graphite-light bg-brand-graphite-light px-5 py-4">
                <p className="font-display text-body-sm text-brand-white">What Happens Next</p>
                <div className="mt-4 flex flex-col gap-4">
                  <Step n={1} label="Your request and uploaded photos are saved in the admin dashboard." done />
                  <Step n={2} label="A technician will review the wheel damage and confirm the final quote." />
                  <Step n={3} label="Western Wheelcraft will contact you directly to confirm timing and payment method." />
                </div>
              </div>
            </div>
          </div>
